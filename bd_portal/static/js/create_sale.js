$(document).ready(function () {
    ...
    */
    ...
    function myFunction() {
        console.log("Function executed after 3 seconds of inactivity.");
        let url = "/ajax/check_unique_order"
        var data = {
        ...
        $.post(url,
            ...
            function (data, status) {
                ...
                if (data == 'exist') {
                    $('#order_number_error').text('Already Exists');
                }
    ...
    $('#order_number').on('keyup change', function () {
        ...
        timer = setTimeout(function () {
            myFunction(); // Call the function after 3 seconds of no typing
        }, 1000);
    });
